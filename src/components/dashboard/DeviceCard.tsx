      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              <h3 className="text-sm font-black tracking-tighter text-foreground uppercase truncate">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-muted p-3 rounded-xl border border-border">
            ...
            <p className="text-xs font-black text-foreground truncate uppercase">{device.city || 'N/A'}</p>
          </div>
        </div>

        {/* Status Bar */}
        <div className="flex items-center justify-between pt-3 border-t border-border">
          <span className="text-[9px] font-black uppercase text-muted-foreground/30 tracking-widest">STATION PROTOCOL</span>
          <div className={cn(
