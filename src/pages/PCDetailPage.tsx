        ...
        <div className="flex items-start gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              {isEditing ? (
                <Input
                  className="text-4xl font-black tracking-tighter uppercase bg-muted border-primary h-14 rounded-2xl text-foreground px-6 focus:ring-primary/20"
                  value={editData.pc_name}
                  onChange={(e) => setEditData({ ...editData, pc_name: e.target.value })}
                />
              ) : (
                <h1 className="text-5xl font-black tracking-tighter uppercase text-foreground font-display leading-tight">{device.pc_name || "STATION"}</h1>
              )}
              <div className={cn(
                "px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-2xl",
          ...
          {isEditing ? (
            ...
            <>
              ...
              >
                ...
                generate system profile audit
              </Button>


              <Button variant="ghost" size="lg" onClick={() => setIsEditing(true)} className="bg-muted border border-border hover:bg-muted/80 font-black text-[10px] tracking-widest uppercase rounded-2xl px-6 transition-all text-foreground">
              ...
              <Button
                variant="destructive"
                size="lg"
                className="bg-pink-500/10 text-pink-500 border border-pink-500/20 hover:bg-pink-500 hover:text-white transition-all font-black text-[10px] tracking-widest uppercase rounded-2xl px-6"
                onClick={() => {
        ...
        <div className="space-y-6">
          <Card className="glass-card premium-border rounded-[2.5rem] overflow-hidden">
            <CardHeader className="p-8 pb-4">
              <CardTitle className="text-[10px] font-black tracking-[0.4em] text-primary uppercase opacity-80">Registry Core</CardTitle>
            </CardHeader>
            <CardContent className="p-8 pt-4 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-black text-xl uppercase tracking-tighter text-foreground mt-0.5">{device.city}</p>
                    )}
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-black text-xl uppercase tracking-tighter text-foreground mt-0.5">{device.lab_name}</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="p-5 rounded-[1.5rem] bg-pink-500/5 border border-pink-500/10">
                ...
                <p className="font-black text-lg text-foreground mt-3 uppercase tracking-tighter">
              ...
              <div className="p-6 rounded-[2rem] bg-gradient-to-br from-primary/10 to-secondary/5 border border-border relative overflow-hidden group">
                ...
                <div className="flex items-baseline justify-between">
                  <div className="flex items-baseline gap-3">
                    <span className="text-5xl font-black tracking-tighter text-foreground text-glow-pink">
                      {device.cpu_score || 0}
                    </span>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-[10px] font-black text-foreground">60.0 Hz</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="glass-card premium-border rounded-[2.5rem] overflow-hidden">
            <CardHeader className="p-8 pb-4">
              <CardTitle className="text-[10px] font-black tracking-[0.4em] text-cyan-400 uppercase opacity-80">Software Spectrum</CardTitle>
            </CardHeader>
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <Card className={cn(
              ...
              <CardContent className="p-8 flex items-center gap-6">
                ...
                <div>
                  ...
                  <h2 className={cn(
                    "text-3xl font-black uppercase tracking-tighter leading-tight",
            ...
            <Card className="glass-card rounded-[2.5rem] premium-border bg-purple-500/[0.03] border-purple-500/20">
              <CardContent className="p-8 flex items-center gap-6">
                ...
                <div>
                  ...
                  <h2 className="text-3xl font-black uppercase tracking-tighter leading-tight text-foreground">
                    SECURED
                  </h2>
          ...
          <Card className="glass-card premium-border rounded-[2.5rem] overflow-hidden">
            <CardHeader className="p-8 pb-0 flex flex-row items-center justify-between">
              <div>
                <CardTitle className="text-[10px] font-black tracking-[0.4em] text-foreground uppercase opacity-80">Telemetry Archives</CardTitle>
              ...
              {history && history.length > 0 ? (
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-separate border-spacing-y-4">
                    <thead>
                      <tr className="text-[9px] font-black uppercase text-muted-foreground/60 tracking-[0.2em]">
                          ...
                          >
                            <td className="px-6 py-5 bg-muted/20 rounded-l-[1.5rem] border-y border-l border-border">
                              <div className="flex flex-col">
                                <span className="font-black text-foreground uppercase tracking-tighter text-sm">{dateObj.toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' }).toUpperCase()}</span>
                            ...
                            <td className="px-6 py-5 bg-muted/20 rounded-r-[1.5rem] border-y border-r border-border text-right">
                              <div className="flex flex-col items-end">
                                <span className="text-lg font-black text-foreground leading-none">{h.avg_score || 0}</span>
                ...
                <div className="p-16 text-center border-2 border-dashed border-border rounded-[2.5rem] bg-muted/20 opacity-40">
                  ...
                  <p className="text-muted-foreground font-black uppercase text-[10px] tracking-[0.3em]">No Historical Sequence Found</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <div className="p-8 pt-2 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-5 rounded-3xl bg-muted border border-border">
                ...
                <p className="text-3xl font-black text-primary tracking-tighter">{selectedHistory?.avg_score || 0} <span className="text-xs uppercase ml-1">Units</span></p>
              </div>
              <div className="p-5 rounded-3xl bg-muted border border-border">
