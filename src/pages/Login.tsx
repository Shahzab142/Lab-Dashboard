      ...
      <Card className="w-full max-w-md glass-card relative z-10 animate-in fade-in-0 zoom-in-95 duration-700 p-2">
        <CardHeader className="text-center space-y-3 pb-8 pt-10 px-8">
          ...
          <div className="space-y-2">
            <CardTitle className="text-4xl font-black tracking-tighter text-foreground uppercase font-display">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-3 p-5 rounded-2xl bg-muted border border-border group">
              ...
              <div className="flex items-center gap-4">
                <div className="flex-1 flex items-center justify-center h-14 rounded-xl bg-background border border-border text-xl font-black text-cyan-400 tracking-widest select-none font-mono">
            ...
            <Button
              type="submit"
              className="w-full h-14 bg-primary hover:bg-primary/90 text-primary-foreground font-black text-sm tracking-widest shadow-2xl glow-pink transition-all hover:scale-[1.02] active:scale-[0.98] rounded-2xl uppercase"
              disabled={isLoading}
            >
              {isLoading ? (
