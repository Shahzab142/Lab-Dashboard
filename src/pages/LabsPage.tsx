        ...
        <div className="p-4 md:p-8 space-y-8 animate-in slide-in-from-right-4 duration-700">
            <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-white/5">
                <div className="space-y-4">
                    ...
                    <div>
                        <h1 className="text-4xl font-black tracking-tighter uppercase text-foreground font-display">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                    ...
                    >
                        <Building2 size={16} className="text-primary group-hover:scale-110 transition-transform" />
                        generate CityPDF
                    </Button>
            ...
            {isLoading ? (
                ...
                <div className="p-20 text-center glass-card border-dashed border-border rounded-[3rem]">
                    ...
                    <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">No Access Points Detected</h3>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            ...
                            >
                                <CardContent className="p-6 flex flex-col justify-between h-full space-y-4">
                                    ...
                                    <div className="flex items-end justify-between border-t border-border/50 pt-4">
                                        ...
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-3xl font-black text-[#00ff9d] tracking-tighter text-glow-cyan">{online}</span>
