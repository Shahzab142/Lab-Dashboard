        ...
        <div className="h-[calc(100vh-2rem)] flex flex-col bg-[#0F0A1E] text-slate-200 font-sans p-4 lg:p-6 overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col relative z-10 w-full h-full">
                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 shrink-0">
                    ...
                    <div className="flex items-center gap-4 bg-black/40 p-1.5 rounded-2xl border border-white/5 backdrop-blur-xl shadow-2xl">
                        <div className="flex items-center gap-1">
                            <button
                                ...
                                className={cn(
                                    ...
                                    sortBy === 'pcs' ? "bg-violet-600 text-white shadow-lg" : "text-slate-500 hover:text-white hover:bg-white/5"
                                )}
                            >
                            ...
                            <button
                                ...
                                disabled={viewLevel === 'labs'}
                                className={cn(
                                    "flex items-center gap-2 px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all",
                                    sortBy === 'labs' ? "bg-violet-600 text-white shadow-lg" : "text-slate-500 hover:text-white hover:bg-white/5",
                                    viewLevel === 'labs' && "opacity-20 cursor-not-allowed group-hover:bg-transparent"
                                )}
                            >
                                <Globe className="w-3.5 h-3.5" /> Labs
                            </button>
                        </div>
                    </div>
                </header>
